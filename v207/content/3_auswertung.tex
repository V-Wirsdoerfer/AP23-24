...
nur alle zwei Messungen gedreht werden. Folgende Fallzeiten wurden gemessen: %Formulierung scheiße vom letzten Satz
...
\begin{table*}
    ...
    \begin{tblr}{
        ...
        Re \\
        \midrule
        $\text{statisch}_\text{klein}$   & 0.99821   &    10  &  12.52   &   1.559 & 1.356\pm0 0.005 & 14.606 \pm 0.014 \\
        $\text{statisch}_\text{groß}$    & 0.99821   &    5   &  46.59   &   1.576 & 1.370\pm0 0.007 & 7.468 \pm 0.024 \\
        $\text{dynamisch}_\text{groß}$   & 0.99821   &    5   &  25.35   &   1.576 & 0.7281\pm0 0.0022 & 13.8 \pm 0.04 \\
        \bottomrule 
    \end{tblr}
