...
\begin{table}
    ...
    \begin{tblr}{
        ...
        \frac{a}{\bar w} \\
        \midrule
        \text{blau \ref{fig:1}}     &   298.15  &   \num{0.0053}    &   \num{5.47e-01}  &   \num{1.83e+00}  \\  
        \text{rot \ref{fig:1}}      &   414.55  &   \num{3.44}      &   \num{8.42e-04}  &   \num{1.19e+03}  \\  
        \text{blau \ref{fig:2}}     &   438.15  &   \num{8.41}      &   \num{3.45e-04}  &   \num{2.90e+03}  \\  
        \text{rot klein \ref{tab:1}}    &438.15 &   \num{8.41}      &   \num{3.45e-04}  &   \num{2.90e+03}  \\  
        \text{rot groß \ref{tab:1}}     &447.15 &   \num{11.5}      &   \num{2.51e-04}  &   \num{3.98e+03}  \\  
        \text{blau \ref{tab:1}}     &   459.15  &   \num{17.2}      &   \num{1.68e-04}  &   \num{5.95e+03}  \\ 
        \bottomrule
    \end{tblr}
    \label{tab:basics}
  \end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{../build/Steigung.pdf}
