...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Ladungsauftragung.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{Ladung_exkludiert.pdf}
    \caption{Verteilung korrigierte und unkorrigierter Ladungen}
\end{figure*}
...
\begin{figure*}
    \includegraphics[width=\textwidth]{e0_mean.pdf}
...
\begin{figure*}
    \includegraphics[width=\textwidth]{e0_reduziert.pdf}
    \caption{Mittelwert berechnen unter Rücksicht auf Fehler}
\end{figure*}
