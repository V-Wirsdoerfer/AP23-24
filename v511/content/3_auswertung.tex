...
\begin{figure}[H]
    \label{Kupfer}
    \includegraphics[height=8cm]{../build/Kupfer.pdf}
...
\begin{figure}[H]
    \label{Silber}
    \includegraphics[height=8cm]{../build/Silber.pdf}
...
\begin{figure}[H]
    \label{Zink}
    \includegraphics[height=8cm]{../build/Zink.pdf}
...
\begin{figure}[H]
    \includegraphics[height=8cm]{../build/constB.pdf}
...
Diese weiteren Größen werden nun in der folgenden Tabelle aufgeführt:
