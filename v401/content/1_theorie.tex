...
\noindent kann die folgende Formel zu direkten Berechnung der Brechungszahl $n$ angewendet werden:

\begin{equation}
\label{eqn:Brechungsindex}
    n = 1 + \frac{z\lambda}{2D}\cdot\frac{T}{T_0}\frac{p_0}{\increment{}p}
\end{equation}

\noindent Hierbei ist die $\increment{}p$ die Druckdiffernz und $T_0$ bzw $p_0$ die Temperatur bzw. der Druck bei Normalbedingungen.
$T$ ist die zum Zeit des Versuchs vorherrschende Raumtemperatur, die es zu messen gilt. Die Länge der Gaszelle in einem der Strahlengänge 
