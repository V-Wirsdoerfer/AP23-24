...
welche mithilfe des Ultraschall lokalisiert werden sollen.


\begin{minipage}[\baselineskip]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{content/Augenmodell.png}
