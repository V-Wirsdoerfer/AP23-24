...
der Fokus hier jedoch nur auf einer beider Wege liegt. $H_\text{Top,korr}$ und $H_\text{Bottom,korr}$ sind also zwei \emph{numpy.arrays},
welche die Gesamtwege (mit Anpassungsschicht) des Ultraschalls der jeweiligen Löcher beinhalten. Von diesen \emph{arrays} werden nun die gemessenen Strecken 
abgezogen, sodass aus dem Mittelwert die Dicke der Anpassungsschicht berechnet werden kann:  
...
\begin{table}
    ...
    \begin{tblr}{
        ...
        \midrule 
        1   &   1.20\pm2.71\cdot10^{-2} \\
        2   &   1.45\pm2.71\cdot10^{-2} \\
        3   &   6.20\pm2.71\cdot10^{-2} \\
        4   &   5.11\pm2.71\cdot10^{-2} \\
        5   &   4.05\pm2.71\cdot10^{-2} \\
        6   &   3.14\pm2.71\cdot10^{-2} \\
        7   &   3.15\pm2.71\cdot10^{-2} \\
        8   &   3.21\pm2.71\cdot10^{-2} \\
        9   &   3.26\pm2.71\cdot10^{-2} \\
        10  &   1.16\pm2.71\cdot10^{-2} \\
        11  &   6.48\pm2.71\cdot10^{-2} \\
        \bottomrule 
    \end{tblr}
\end{table}
