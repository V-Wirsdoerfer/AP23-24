...
\begin{figure}[H]
    \centering
    \includegraphics[height=7.5cm]{../build/Entladungskurve.pdf}
...
\begin{figure}
    \centering
    \includegraphics[height=7.5cm]{../build/Amplitudenspannung.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=7.5cm]{../build/phi(f).pdf}
...
\begin{figure}
    \centering
    \includegraphics[height=7.5cm]{../build/polar2.pdf}
...
\begin{figure}
    ...
    \begin{subfigure}
        \centering
        \includegraphics{Dreiecksspannung.jpg}
        \caption{Dreiecksspannung}
        \label{fig:Rechteck}
    \end{subfigure}
    \begin{subfigure}
        \centering
        \includegraphics{Sinusspannung.jpg}
