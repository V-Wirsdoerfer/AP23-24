...
Der durch curve\_fit berechnete Parameter der Ausgleichsgerade lautet demnach:
...
\noindent Durch korrektes Umstellen der Gleichung \eqref{eqn:Phase_Amplitude} kann die Zeitkonstante bestimmt werden:
...
\begin{figure}[H]
    ...
    \caption{Zusammenhang zwischen Frequenz $f$ und Phasenverschiebung $\varphi$.}
...
\noindent Zuletzt wird gezeigt, dass der RC-Kreis auch als Integrator fungieren kann. Wie in der Theorie postuliert muss dafür die Kreisfrequenz $\omega$
