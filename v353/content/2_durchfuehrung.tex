...
Über Gleichung \autoref{eqn:Phase_Amplitude} ist es damit möglich die Zeitkonstante zu bestimmen.
Ebenfalls ist es möglich über die Phasenverschiebung $\varphi$ der Spannungen mit Hilfe von Gleichung \autoref{eqn:Phasenverschiebung} 
